$(document).ready(function(){
    ...
    */
    ...
    /************************ 끝 : 찾습니다 swiper ***************/
    /************************ 시작 : 찾습니다 tab ***************/
    // .find .tab_list ul li를 클릭했을때 1번째를 클릭하면 active 클래스를 주고
    // li에서 어떤 tab_item을 보이게 해야하는지 단서를 줘야함
    // .find .tab_content .tab_item에서 1번째 요소에 active 클래스를 줌
    // 
    ...
    $('.find .tab_list ul li').on('click',function(){
        ...
        // 클릭한 li와 관련된 tab_content tab_item에 active 클래스 주기
        tab_name = $(this).attr('data-tab')
        // console.log(tab_name)
        $('.find .tab_content .tab_item').removeClass('active')
        // find로 찾을땐 클래스명이면 .이 추가되어야함, 근데 내가 가져온 이름은 .이 없음
