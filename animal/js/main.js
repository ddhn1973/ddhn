$(document).ready(function(){
    ...
    */
    ...
    $('header .gnb .gnb_wrap ul.depth1 > li > a').on('click', function(e){
        if(device_status == 'mobile'){
            ...
            if($(this).parent().hasClass('open') == true){
                ...
                // console.log('닫힘')
                $('header .gnb .gnb_wrap ul.depth1 > li > a').removeClass('open') // 모든 open을 삭제
    ...
    /************************ 끝 : mobile버전 1차 메뉴 클릭 ***************/
    /************************ 시작 : mobile버전 메뉴 열기 ***************/
    // 열기를 클릭하면 header에 menu_mo클래스 추가
    // header .gnb .gnb_open
    // 닫기를 클릭하면 header에 menu_mo클래스 삭제
    ...
    // 다시 맨꼭대기로 올라가면 header에 fixed 클래스 삭제
